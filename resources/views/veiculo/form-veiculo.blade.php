<!-- Modal inserir Veículo-->
    <div class="modal-dialog ">
        <div class="modal-content animated bounceInRight">
            ...
            @if (isset($objReturn['categoria']))
                        
                {!!Form::model($objReturn['veiculo'], ['route'=>['editar-veiculo', $objReturn['veiculo']->id_veiculo], 'class' =>"smart-form "  , 'method'=> 'POST', 'id'=> 'form_modal' ] ) !!}
            @else
                {!!Form::open(['route'=>['inserir-veiculo'], 'class' =>"smart-form "  , 'method'=> 'POST', 'id'=> 'form_modal' ] ) !!}
            @endif

                {!!Form::token()!!}
                {!! Form::hidden('id_veiculo')!!}
